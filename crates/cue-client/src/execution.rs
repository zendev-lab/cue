...
impl ExecutionClient {
    ...
    pub async fn execute_surface(
        ...
        let result = match command {
            SurfaceCommand::Submit(spec) => ResultPayload::ExecutionSubmitted {
            ...
            SurfaceCommand::GetExecution { id } => self.query(Query::GetExecution { id }).await?,
            SurfaceCommand::WaitExecution { id } => self.query(Query::WaitExecution { id }).await?,
